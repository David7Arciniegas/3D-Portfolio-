    ...
    >
      ...
      >
        ...
        >
          ...
          h-9 object-contain"
          />
          <p className="text-white-[18pc] font-bold cursor-pointer flex">
            David &nbsp; <span className="sm:block hidden">| Arciniegas</span>
          </p>
        </Link>
        ...
        >
          ...
          p-6 blac-gradient absolute top-20 right-0 mx-4 my-2
